  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        rustico: {
          green: "hsl(var(--rustico-green))",
          "green-light": "hsl(var(--rustico-green-light))",
          "green-dark": "hsl(var(--rustico-green-dark))",
          black: "hsl(var(--rustico-black))",
          charcoal: "hsl(var(--rustico-charcoal))",
          gray: "hsl(var(--rustico-gray))",
          "gray-light": "hsl(var(--rustico-gray-light))",
          white: "hsl(var(--rustico-white))",
        },
      },
      fontFamily: {
      ...
      backgroundImage: {
        ...
        "gradient-hero": "linear-gradient(135deg, hsl(0 0% 6%) 0%, hsl(0 0% 10%) 50%, hsl(152 82% 40% / 0.1) 100%)",
