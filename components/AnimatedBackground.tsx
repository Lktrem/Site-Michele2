...
const AnimatedBackground = memo(() => {
  ...
  useEffect(() => {
    ...
    const motionQuery = typeof window.matchMedia === 'function' 
      ...
      : null;
    isReducedMotion.current = motionQuery?.matches ?? false;
    isMobile.current = window.innerWidth < 768;

    // Skip animation entirely on mobile/iOS or reduced motion
    if (isReducedMotion.current || isMobile.current) return;
  ...
  // Skip rendering on mobile or reduced motion
